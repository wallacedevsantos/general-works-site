        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-construction-gray mb-4">
              Entre em <span className="text-construction-orange">Contato</span>
            </h2>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              <Card className="border-0 shadow-lg">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4 mb-4">
                    ...
                    <div>
                      <h3 className="font-bold text-construction-gray">Telefone</h3>
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 bg-construction-blue/10 rounded-full flex items-center justify-center">
                      <Mail className="w-6 h-6 text-construction-blue" />
                    </div>
                    <div>
                      <h3 className="font-bold text-construction-gray">E-mail</h3>
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 bg-construction-gray/10 rounded-full flex items-center justify-center">
                      <MapPin className="w-6 h-6 text-construction-gray" />
                    </div>
                    <div>
                      <h3 className="font-bold text-construction-gray">Atendimento</h3>
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-construction-gray">Horário</h3>
